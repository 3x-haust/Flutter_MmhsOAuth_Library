...
void main() {
  test('Create MirimOAuth instance', () {
    final mirimOAuth = MirimOAuth(
      clientSecret:
          'eaf7f737-c560-40da-9391-78aaf1cf06bd-6800f62a-7773-4717-8e23-907fe604f7f8',
      clientId: '658dd13e-e7ab-4832-9abc-c5584f624a1e',
      redirectUri: 'mirimauth://callback',
      scopes: ['email', 'nickname', 'major'],
    );

    expect(mirimOAuth.clientId, equals('658dd13e-e7ab-4832-9abc-c5584f624a1e'));
  ...
  test('MirimUser fromJson', () {
    ...
    expect(user.profileImageUrl, equals('/uploads/avatars/student.png'));
  });
}
